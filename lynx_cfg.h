...
#define LYNX_CFG_FILE "/data/local/tmp/etc/lynx.cfg"		/* $sysconfdir/lynx.cfg */
#define LYNX_CFG_PATH "/data/local/tmp/etc"		/* $sysconfdir */
#define LYNX_LSS_FILE "/data/local/tmp/etc/lynx.lss"		/* $sysconfdir/lynx.lss */
...
#define SYSTEM_NAME "linux-androideabi"		/* CF_CHECK_CACHE */
