...
static const struct {
	...
	{ "define_sigwinch",	"'no'" },
	{ "env_CC_set",	"'set'" },
	{ "env_CC_value",	"'/tmp/chain/bin/arm-linux-androideabi-gcc'" },
	{ "env_CFLAGS_set",	"'set'" },
	{ "env_CFLAGS_value",	"'-UHAVE_TTYNAME -UHAVE_LOCALE_H --sysroot=/opt/ndk/platforms/android-17/arch-arm -I/opt/ndk/platforms/android-17/arch-arm/usr/include -I/tmp/chain/include -I/opt/android/bionic -I/data/local/tmp/lib/include'" },
	{ "env_CPPFLAGS_set",	"'set'" },
	{ "env_CPPFLAGS_value",	"'-UHAVE_TTYNAME -UHAVE_LOCALE_H --sysroot=/opt/ndk/platforms/android-17/arch-arm -I/opt/ndk/platforms/android-17/arch-arm/usr/include -I/tmp/chain/include -I/opt/android/bionic -I/data/local/tmp/lib/include'" },
	{ "env_CPP_set",	"'set'" },
	{ "env_CPP_value",	"'/tmp/chain/bin/arm-linux-androideabi-cpp'" },
	{ "env_LDFLAGS_set",	"'set'" },
	{ "env_LDFLAGS_value",	"' -L/opt/ndk/platforms/android-17/arch-arm/usr/lib -L/tmp/chain/lib -L/data/local/tmp/lib'" },
	{ "env_build_alias_set",	"''" },
	{ "env_build_alias_value",	"''" },
	{ "env_host_alias_set",	"'set'" },
	{ "env_host_alias_value",	"'arm-linux-androideabi'" },
	{ "env_target_alias_set",	"''" },
	{ "env_target_alias_value",	"''" },
	{ "fancy_curses",	"'yes'" },
	{ "find_linkage_iconv",	"'no'" },
	{ "find_linkage_idn",	"'no'" },
	...
	{ "header_path_iconv",	"'/data/local/tmp/lib/include'" },
	{ "header_path_idn",	"'/data/local/tmp/lib/include'" },
	{ "header_path_ssl",	"'/data/local/tmp/lib/include/openssl'" },
	...
	{ "path_lastlog",	"'no'" },
	{ "pkg_config_ssl",	"'no'" },
	{ "prog_AR",	"'/tmp/chain/bin/arm-linux-androideabi-ar'" },
	{ "prog_BUILD_CC",	"'gcc'" },
	{ "prog_CC",	"'/tmp/chain/bin/arm-linux-androideabi-gcc'" },
	{ "prog_CPP",	"'/tmp/chain/bin/arm-linux-androideabi-cpp'" },
	{ "prog_LINT",	"'lint'" },
	{ "prog_MAKE_LOWER_TAGS",	"'no'" },
	{ "prog_MAKE_UPPER_TAGS",	"'no'" },
	{ "prog_RANLIB",	"'/tmp/chain/bin/arm-linux-androideabi-ranlib'" },
	{ "prog_YACC",	"'bison -y'" },
	{ "prog_cc_g",	"'yes'" },
	{ "prog_cc_stdc",	"''" },
...
static const struct {
	...
	{ "LOCALE",	"1" },
	{ "LONG_LIST",	"1" },
	{ "LYNX_CFG_FILE",	"\"/data/local/tmp/etc/lynx.cfg\"" },
	{ "LYNX_CFG_H",	"1" },
	{ "LYNX_CFG_PATH",	"\"/data/local/tmp/etc\"" },
	{ "LYNX_LSS_FILE",	"\"/data/local/tmp/etc/lynx.lss\"" },
